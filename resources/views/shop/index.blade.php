    ...
    {{-- <section class="py-10 bg-white sm:py-16 lg:py-24">
        <div class="max-w-5xl px-4 mx-auto sm:px-6 lg:px-8">
            <div class="grid items-center md:grid-cols-2 gap-y-10 md:gap-x-20">
                ...
                <div>
                    <h2 class="text-3xl font-bold leading-tight text-emerald-600 sm:text-4xl lg:text-5xl">Browse Our
                        Products</h2>
                    <p class="mt-4 text-base leading-relaxed text-gray-700">Amet minim mollit non deserunt ullamco est
