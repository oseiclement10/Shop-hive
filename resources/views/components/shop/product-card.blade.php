...
<div class="bg-slate-100/80 px-6 py-3 relative rounded-md">
    ...
    <h3 class=" capitalize  text-base font-semibold text-slate-800"> {{ $stock->product->name }} </h3>
    ...
    <div class="flex items-center space-x-2">
        <div class="flex">
            @for ($i = 0; $i < $stock->product->reviewsAverage(); $i++)
        ...
        <p class="text-xs text-gray-500">{{$stock->product->reviews()->count()}} Reviews</p>
    </div>
