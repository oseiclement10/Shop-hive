<x-layouts.index>
    <section class="min-h-dvh bg-slate-100 flex flex-col items-center justify-center">
        <section>
            ...
            <x-forms.form name="verify-email" class="w-[500px] py-10 shadow-sm bg-white px-8 rounded-lg"
                action="/vendor/email/verification-notification" method="post">
                @if (session('resent'))
                ...
                <p class="text-center text-slate-700 mb-2">
                    Email Verification Link has been sent to your email address Click on the link sent to your email to
