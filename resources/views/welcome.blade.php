...
<div class="bg-white">
    <header class="absolute  inset-x-0 top-0 z-50">
        ...
        <div class="h-[14px] bg-amber-300 "></div>
    </header>
        ...
        <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
            <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                <div
                    ...
                    Announcing our next round of funding. <a href="#"
                        class="font-semibold text-emerald-600"><span class="absolute inset-0"
            ...
            <div class="text-center">
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="#"
                        class="rounded-md bg-emerald-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-emerald-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Get
                        started</a>
